...
export const LABEL_CSS = `
      *{box-sizing:border-box}
      ...
      body{font-family:Arial,Helvetica,sans-serif;color:#111;background:#fff;padding:5mm}
      .label{margin:0;border:1px solid #111;padding:10px 8px 6px 8px;page-break-after:always}
      ...
      .courier-mini{position:absolute;top:0;right:0;background:#111;color:#fff;font-weight:800;font-size:11px;padding:3px 7px;border-radius:3px;letter-spacing:.03em;white-space:nowrap}
