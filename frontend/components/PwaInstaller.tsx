  ...
  return (
    <div style={{ position: 'fixed', right: 12, bottom: 78, zIndex: 1000, display: 'flex', alignItems: 'center', gap: 6 }}>
      <a href={PLAY_STORE} target="_blank" rel="noopener noreferrer"
        onClick={dismiss}
        style={{ background: '#722f37', color: '#fff', borderRadius: 22, padding: '.5rem .9rem', fontWeight: 700, fontSize: '.8rem', textDecoration: 'none', boxShadow: '0 3px 12px rgba(0,0,0,.2)', whiteSpace: 'nowrap', display: 'inline-flex', alignItems: 'center', gap: 6 }}>
