  ...
  if (step === 'confirm') return (
    <div style={{ maxWidth: '520px', margin: '0 auto', padding: '4rem 1.5rem', textAlign: 'center' }}>
      ...
      <p style={{ color: '#666', fontSize: '.92rem', marginBottom: '1.5rem' }}>
        Apne order ke updates ke liye humein WhatsApp par message karein 👇
      </p>
      <div style={{ display: 'flex', flexDirection: 'column', gap: '.85rem', alignItems: 'center' }}>
        <a
          href={`https://wa.me/919429429880?text=${encodeURIComponent(`Hello Mahalaxmi Fashion Hub 🙏\nMera order place ho gaya hai.\nOrder ID: ${orderId}\nKripya mujhe order ki jaankari aur updates WhatsApp par bhej dein.`)}`}
